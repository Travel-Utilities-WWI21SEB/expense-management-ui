	...
	<div class="relative overflow-hidden rounded-lg">
		...
		{#if debts.debts && debts.debts.length > 0}
			<div class="grid grid-rows-2 grid-cols-none lg:grid-rows-none lg:grid-cols-3">
				<button on:click={() => goto('/debts')} class="card-hover p-4 row-span-1 lg:col-span-1">
					<div
				...
				<button on:click={() => goto('/debts')} class="card-hover p-4 row-span-1 lg:col-span-2">
		...
		{:else}
			<section class="mt-4">
				<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 flex justify-center">
					<div class="mx-auto h-10 md: h-auto text-center">
						<h2
